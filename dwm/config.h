...
static const Key keys[] = {
	...
	{ MODKEY,                  XK_e,         spawn,    {.v = (const char*[]){ TERMINAL, "lf", NULL } } },
        ...
        { MODKEY,                  XK_semicolon, spawn,   {.v = (const char*[]){ "mpc", "pause", NULL } } },
	{ MODKEY|ShiftMask,        XK_semicolon, spawn,   {.v = (const char*[]){ "mpc", "stop", NULL } } },
        { MODKEY,                  XK_apostrophe, spawn,   {.v = (const char*[]){ "mpc", "play", NULL } } },
