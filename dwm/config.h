...
static const Key keys[] = {
	...
	{ Mod1Mask|ShiftMask,             XK_bracketright,  setgaps,        {.i = 0 } },
	...
	{ MODKEY,                  XK_w,     spawn, {.v = (const char*[]){"firefox", NULL} } },
        ...
        { MODKEY|ShiftMask,                  XK_d,            spawn, {.v = (const char*[]){"rofi", "-show", "run", NULL } } },
	...
	{ MODKEY|ShiftMask,        XK_semicolon, spawn,   {.v = (const char*[]){ "xmms2", "stop", NULL } } },
        { MODKEY,                  XK_apostrophe, spawn,   {.v = (const char*[]){ "xmms2", "play", NULL } } },
        { MODKEY|ShiftMask,                  XK_bracketleft, spawn,   {.v = (const char*[]){ "xmms2", "seek", "-5", NULL } } },
        { MODKEY|ShiftMask,                  XK_bracketright, spawn,   {.v = (const char*[]){ "xmms2", "seek", "+5", NULL } } },
